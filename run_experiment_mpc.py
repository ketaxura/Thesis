...
def build_mpc_solver(static_rects, num_dyn_obs):
    ...
    for k in range(N):
        ...
        # Wall constraints (using zigzag bounds as conservative default)
    ...
    solver = ca.nlpsol("solver_mpc", "ipopt",
...
# Main run function
# ----------------------------------------------------------------
def run_mpc(path_id: int, seed_offset: int, max_steps: int = 800) -> dict:
    ...
    for k in range(max_steps):
        ...
        # Matches MPCC: robot at k+1 vs obstacle at k+1
        obstacles.step()
