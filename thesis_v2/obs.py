        ...
        def dynamic_obs(self):
            ...
            if self.path_id == 3:
                ...
                dyn_obs.append(DynamicObstacle(
                    ...
                    seed=0, v_max=0.5, change_interval=20
                ))

                dyn_obs.append(DynamicObstacle(
                    x0=18.0, y0=2.0, a=0.6, b=0.4,
                    seed=1, v_max=0.5, change_interval=20
                ))

                dyn_obs.append(DynamicObstacle(
                    x0=14.0, y0=2.0, a=0.6, b=0.4,
                    seed=2, v_max=0.5, change_interval=20
                ))


                dyn_obs.append(DynamicObstacle(
                    x0=5.5, y0=3.5, a=0.6, b=0.4,
                    seed=2, v_max=0.0, change_interval=20
                ))

                dyn_obs.append(DynamicObstacle(
                    x0=10.0, y0=-1.0, a=0.6, b=0.4,
                    seed=56, v_max=0.5, change_interval=20
                ))
...
class DynamicObstacle:
    ...
    def predict_horizon(self, N, dt):
        """
        Return two arrays obs_x (N,) and obs_y (N,) giving the predicted
        position at horizon steps 1..N (matching constraint on X[:,k+1]).
        Step 0 is skipped — that's x_current which is already committed.
        """
